            ...
            <div class="mb-3">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-3 gap-3 mb-3">
                    <template
                        ...
                        :key="attachment.id">
                        <div class="group bg-blue-100 aspect-squar rounded flex flex-col items-center justify-center  text-gray-500 relative ">

                            <!-- download -->
                            <button class="opacity-0 group-hover:opacity-100 transition-all w-8 h-8 flex items-center justify-center text-gray-100 bg-gray-600 rouded absolute right-1 top-2 cursor-pointer hover:bg-gray-800 transition duration-150 ease-in-out">
